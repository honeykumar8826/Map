...
import com.map.R;
import com.map.adapter.ImageLoadAdapter;
import com.map.adapter.PlaceImageAdapter;
import com.map.adapter.TrendingImageAdapter;
import com.map.modal.ImageModal;
import com.map.modal.PlaceImageModal;
import com.map.modal.TrendingImageModal;
import com.map.network.NetworkClient;
    ...
    private void setUpBottomSheet() {
        bottomSheetBehavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View view, int newState) {
                switch (newState) {
                    case BottomSheetBehavior.STATE_COLLAPSED:
                        Toast.makeText(HomeActivity.this, "collaped", Toast.LENGTH_SHORT).show();
                        break;
                    case BottomSheetBehavior.STATE_EXPANDED:
                        Toast.makeText(HomeActivity.this, "expand", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        Toast.makeText(HomeActivity.this, "default", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
            ...
            public void onSlide(@NonNull View view, float v) {
                ...
                if (v == 0) {
                    Toast.makeText(HomeActivity.this, "v=0", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                if (t instanceof IOException) {
                    ...
                    Toast.makeText(HomeActivity.this, "Big Issue", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    if (result != null) {
                        ...
                        if (status.equals("ok") && totalItem > 0) {
                            ...
                            if (jsonArray.length() > 0) {
                                ...
                                PlaceImageAdapter imageLoadAdapter = new PlaceImageAdapter(HomeActivity.this, imageModalList);
...
//                                Log.i(TAG, "values inside the for loop: " + authorName + "title" + title + "imgUrl" + imgUrl);
                                ...
                                TrendingImageAdapter imageLoadAdapter = new TrendingImageAdapter(HomeActivity.this, imageModalList);
